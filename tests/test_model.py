...
MODEL_PATH = "checkpoints/phobert_best.pth"
TRAIN_SPLIT = 0.8
...
def main():
    ...
    plt.tight_layout()
    cm_path = os.path.join('checkpoints', 'test_confusion_matrix.png')
    ...
    plt.legend()
    plt.tight_layout()
    dist_path = os.path.join('checkpoints', 'test_confidence_distribution.png')
